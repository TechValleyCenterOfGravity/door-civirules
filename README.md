...
The page is generated by the `setting-admin` mixin from the metadata in
`settings/doorsync.setting.php` — there is no form class or template to maintain,
and any setting added there with `group => 'doorsync'` appears on it
